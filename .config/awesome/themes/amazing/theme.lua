...
wppath = os.getenv("HOME") .. "/.local/wallpapers/catppuccin-wallpapers/landscapes/"
wppath_user = os.getenv("HOME") .. "/.local/wallpapers/catppuccin-wallpapers/landscapes/"
	...
	settings = function()
		widget:set_markup(
			markup.fontfg(
				...
				theme.widgetbar_fg,
				" "
					.. string.format("%5.1f", net_now.received)
					.. " ↓↑ "
					.. string.format("%5.1f", net_now.sent)
					.. " "
			)
		)
	end,
...
local mytextclock = wibox.widget.textclock(
	markup.fontfg(theme.font, theme.widgetbar_fg, "%a %d-%m-%Y")
		.. markup.fontfg(theme.font_larger, theme.fg_focus, " %H:%M:%S "),
	1
)
...
screen.connect_signal("request::desktop_decoration", function(s)
	...
	layouts = {
		...
		awful.layout.layouts[1], --www (machi)
		awful.layout.layouts[1], --apps (machi)
		l.floating, --idea
		awful.layout.layouts[1], --water (machi to empty placement)
		l.magnifier, --air (machi)
		awful.layout.layouts[1], --fire (center-work)
		awful.layout.layouts[1], --earth (termfair)
		l.max, --love
	}
			...
			{ -- Right widgets
				...
				wibox.container.background(
					wibox.container.margin(
						wibox.widget({ keyboardText, theme.mykeyboardlayout, layout = wibox.layout.align.horizontal }),
						3,
						6
					),
					theme.arrow2_bg
				...
				wibox.container.background(
					wibox.container.margin(
						wibox.widget({ fsicon, theme.fs.widget, layout = wibox.layout.align.horizontal }),
						2,
						3
					),
					theme.arrow1_bg
