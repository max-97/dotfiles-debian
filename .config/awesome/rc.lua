...
awful.keyboard.append_global_keybindings({
	...
	awful.key({ modkey, altkey }, "0", function()
		...
		beautiful.volume.update()
	end, { description = "sounds volume 0%", group = "awesome" }),
})
